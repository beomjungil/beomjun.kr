...
import { Actor } from '@/activitypub/domain/entities/Actor';
import { type Failure } from '@/activitypub/domain/failures';

import type { ActorRepository } from '@/activitypub/domain/repositories/ActorRepository';
